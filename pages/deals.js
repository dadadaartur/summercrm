...
export default function DealsPage() {
  ...
  const loadAll = async (userId) => {
    const [{ data: profileData }, { data: balanceData }, { data: taskAssignments }, { data: goalsData }, { data: dealsData }] = await Promise.all([
      ...
      supabase.from('deals').select('*, responsible:responsible_user_id ( email, display_name )').order('created_at', { ascending: false })
    ])
    ...
    <>
      ...
      <div className="crm-topbar">
        ...
        <div className="topbar-right">
          ...
          <a className="topbar-name" href="/profile" target="_blank" rel="noopener noreferrer">{displayName}</a>
        </div>
      </div>
